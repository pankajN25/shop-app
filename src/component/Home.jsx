  ...
  const featuredProducts = [
    {
      ...
      price: 99.99,
      image: '/shop-app/assets/homePage/Headphon.png'
    },
    {
      id: 2,
      name: 'Smart Watch',
      price: 199.99,
      image: '/shop-app/assets/homePage/smartwatch.jpg'
    },
    {
      id: 3,
      name: 'Bluetooth Speaker',
      price: 79.99,
      image: '/shop-app/assets/homePage/bluetooth speaker.jpg'
    },
    {
      id: 4,
      name: 'Laptop Backpack',
      price: 49.99,
      image: '/shop-app/assets/homePage/bag.jpg'
    }
  ];

  const categories = [
    { id: 1, name: 'Electronics', image: '/shop-app/assets/homePage/electronic.jpg', route: 'electronics' },
    { id: 2, name: 'Clothing', image: '/shop-app/assets/homePage/clothing.webp', route: 'clothing' },
    { id: 3, name: 'Home & Kitchen', image: '/shop-app/assets/homePage/homeKitchen.jpg', route: 'category/home-kitchen' },
    { id: 4, name: 'Sports', image: '/shop-app/assets/homePage/sport.jpg', route: 'category/sports' }
  ];
  return (
      ...
      <Carousel>
        <Carousel.Item>
          <img
            ...
            src="/shop-app/assets/homePage/shopping.jpeg"
            alt="First slide"
          />
          <Carousel.Caption>
            <h3>Summer Sale</h3>
        ...
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="/shop-app/assets/homePage/Shopping.jpg"
            alt="Second slide"
          />
          <Carousel.Caption>
            <h3>New Arrivals</h3>
